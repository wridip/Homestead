              ...
              <div key={booking._id} className="flex items-start gap-4 p-4 rounded-lg bg-background border border-border hover:border-primary transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Booked by {booking.travelerId?.name || 'Deleted User'} for {booking.nights} nights.
                  </p>
                </div>
              </div>
            ))}
            <Link to="/dashboard/bookings" className="w-full mt-4 text-center text-primary font-semibold hover:underline">
              View all bookings
            </Link>
          </div>
        </div>
