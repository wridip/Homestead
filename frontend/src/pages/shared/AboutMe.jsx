...
const AboutMe = () => {
  ...
  if (loading) return <div className="text-foreground p-8">Loading profile...</div>;

  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl font-bold mb-8 text-foreground">Personal Information</h1>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">Click image to update photo</p>
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-muted border border-border rounded-xl p-3 text-foreground focus:ring-2 focus:ring-ring outline-none transition-all"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                value={authUser?.role}
                disabled
                className="w-full bg-muted/50 border border-border/50 rounded-xl p-3 text-muted-foreground cursor-not-allowed"
              />
            </div>
          </div>

          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-1">Residential Address</label>
            <input
              type="text"
              name="address"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              className="w-full bg-muted border border-border rounded-xl p-3 text-foreground focus:ring-2 focus:ring-ring outline-none transition-all resize-none"
          ...
          <div className="pt-4 flex justify-end">
            <button
              type="submit"
              disabled={saving}
              className="px-8 py-3 bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground font-bold rounded-xl transition-all shadow-lg shadow-primary/20"
            >
