  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <button onClick={handleBooking} className="mt-4 w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700">
              Book Now
            </button>
      ...
      <div className="mt-8">
        ...
        {reviews.length > 0 ? (
          reviews.map(review => (
            <div key={review._id} className="bg-white p-4 rounded-lg shadow-md mt-4">
        ...
        {isAuthenticated && user.role === 'Traveler' && (
          <form onSubmit={handleReviewSubmit} className="mt-8 bg-white p-6 rounded-lg shadow-md">
