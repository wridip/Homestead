      ...
      {/* Hero */}
                        <section data-bg="dark" className="relative overflow-hidden bg-[#121212]">
                          ...
                          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 lg:pb-24 pt-10 pb-16">
                            ...
                            {/* Search Card */}
                            <div className="mx-auto mt-8 max-w-4xl rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E]/70 backdrop-blur shadow-sm" data-animate>
                              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 p-3">
                                <div className="flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] px-3 py-2">
                                  ...
                                  <input type="text" placeholder="Where to?" className="w-full bg-transparent text-sm placeholder-[#E0E0E0]/60 focus:outline-none text-[#E0EE0]" />
                                </div>
                                <div className="flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] px-3 py-2">
                                  ...
                                  <input type="text" placeholder="Dates" className="placeholder-[#E0E0E0]/60 focus:outline-none text-sm bg-transparent w-full" />
                                </div>
                                <div className="flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] px-3 py-2">
                                  ...
                                  <input type="number" min="1" placeholder="Guests" className="w-full bg-transparent text-sm placeholder-[#E0E0E0]/60 focus:outline-none text-[#E0E0E0]" />
                                </div>
                                <Link to="/explore" className="btn-adaptive rounded-lg px-4 py-2 text-center text-sm font-semibold border flex items-center justify-center gap-2 text-[#121212] bg-[#BB86FC] border-[#BB86FC] hover:bg-opacity-80">
                            ...
                            <div className="mx-auto mt-10 grid max-w-6xl grid-cols-2 sm:grid-cols-4 gap-4">
                              <button className="group relative overflow-hidden rounded-xl border border-[rgba(255,255,255,0.1)]" data-animate>
                        ...
                        {/* Featured stays */}
                        <section id="featured" data-bg="dark" className="scroll-mt-16 bg-[#121212] py-12">
                          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="flex items-end justify-between" data-animate>
                              <h2 className="text-2xl tracking-tight font-medium text-[#E0E0E0]">Featured stays</h2>
                              <Link to="/explore" className="btn-adaptive rounded-md px-3 py-1.5 text-sm font-medium border inline-flex items-center gap-2 text-[#BB86FC] border-[#BB86FC]/50 hover:bg-[#BB86FC]/10">
                                Explore all
                        ...
                        {/* How it works */}
                        <section className="border-[rgba(255,255,255,0.1)] border-t pt-14 pb-14 bg-[#121212]" data-bg="dark">
                          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mx-auto max-w-3xl text-center" data-animate>
                              <h2 className="text-3xl tracking-tight font-medium text-[#E0E0E0]">Plan with purpose</h2>
                              <p className="mt-3 text-sm text-[#E0E0E0]/70">Every step is built around safety, trust, and local impact.</p>
                            </div>
                  
                            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
                              <div className="rounded-xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] p-5 hover:border-[rgba(255,255,255,0.2)]" data-animate>
                                <div className="inline-flex h-10 w-10 items-center justify-center rounded-md border border-[rgba(255,255,255,0.1)] bg-[#121212]">
                                ...
                                <h3 className="mt-3 text-base font-semibold tracking-tight text-[#E0E0E0]">Discover</h3>
                                <p className="mt-1 text-sm text-[#E0E0E0]/70">Find handpicked, offbeat stays verified for authenticity and sustainability.</p>
                              </div>
                              <div className="rounded-xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] p-5 hover:border-[rgba(255,255,255,0.2)]" data-animate>
                                <div className="inline-flex h-10 w-10 items-center justify-center rounded-md border border-[rgba(255,255,255,0.1)] bg-[#121212]">
                                ...
                                <h3 className="mt-3 text-base font-semibold tracking-tight text-[#E0E0E0]">Book securely</h3>
                                <p className="mt-1 text-sm text-[#E0E0E0]/70">Protected payments, clear policies, and responsive host support.</p>
                              </div>
                              <div className="rounded-xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] p-5 hover:border-[rgba(255,255,255,0.2)]" data-animate>
                                <div className="inline-flex h-10 w-10 items-center justify-center rounded-md border border-[rgba(255,255,255,0.1)] bg-[#121212]">
                                ...
                                <h3 className="mt-3 text-base font-semibold tracking-tight text-[#E0E0E0]">Travel responsibly</h3>
                                <p className="mt-1 text-sm text-[#E0E0E0]/70">Support local livelihoods and low-impact travel practices.</p>
                              </div>
                            </div>
                          </div>
                        </section>
                        ...
                        <section className="pt-14 pb-14 bg-[#121212]" data-bg="dark">
                          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <div className="mx-auto max-w-3xl text-center" data-animate>
                              <h2 className="text-3xl tracking-tight font-medium text-[#E0E0E0]">Community Photo Wall</h2>
                              <p className="mt-3 text-sm text-[#E0E0E0]/70">Post your favorite moments from your trip or homestay. Tag #Homestead and share them here.</p>
                              <div className="mt-4 flex justify-center">
                                <a href="#" className="btn-adaptive rounded-md px-4 py-2 text-sm font-semibold border inline-flex items-center text-[#BB86FC] border-[#BB86FC]/50 hover:bg-[#BB86FC]/10">
                        ...
                        {/* Host CTA */}
                        <section data-bg="dark" className="overflow-hidden border-y border-[rgba(255,255,255,0.1)] pt-16 pb-16 relative bg-[#121212]" id="host">
                          ...
                          <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8">
                            <div data-animate>
                              <span className="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium ring-1 ring-inset bg-[#BB86FC]/10 text-[#BB86FC] ring-[#BB86FC]/30">
                              ...
                              <h3 className="mt-3 text-3xl tracking-tight font-medium text-[#E0E0E0]">Share your space, empower your community</h3>
                              <p className="mt-3 text-sm text-[#E0E0E0]/70">List your homestay with transparent terms, fair payouts, and guidance on eco-friendly operations.</p>
                              <ul className="mt-4 space-y-2 text-sm text-[#E0E0E0]">
                                <li className="inline-flex items-center gap-2">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-[#BB86FC]"><path d="M21.801 10A10 10 0 1 1 17 3.335"></path><path d="m9 11 3 3L22 4"></path></svg>
                              ...
                              <div className="mt-6 flex flex-wrap gap-3">
                                <a href="#" className="btn-adaptive rounded-md px-4 py-2 text-sm font-semibold border inline-flex items-center gap-2 text-[#121212] bg-[#BB86FC] border-[#BB86FC] hover:bg-opacity-80">
                                ...
                                <a href="#" className="rounded-md border border-[rgba(255,255,255,0.1)] px-4 py-2 text-sm font-medium hover:border-[rgba(255,255,255,0.2)] transition inline-flex items-center gap-2 text-[#E0E0E0]">
                            ...
                            <div className="relative" data-animate>
                              <div className="overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.1)] shadow-sm">
                              ...
                              <div className="hidden sm:block -bottom-4 -left-4 bg-[#1E1E1E] border-[rgba(255,255,255,0.1)] border rounded-xl pt-3 pr-3 pb-3 pl-3 absolute shadow-sm">
                                <div className="flex items-center gap-2">
                                  <div className="h-9 w-9 overflow-hidden rounded-full ring-1 ring-[rgba(255,255,255,0.1)]">
                                  ...
                                  <div>
                                    <p className="text-xs font-medium leading-4 text-[#E0E0E0]">Priya • Host</p>
                                    <p className="text-[11px] text-[#E0E0E0]/60 leading-4">Since 2021</p>
                                  </div>
                                  <div className="ml-auto inline-flex items-center gap-1 text-xs font-medium text-[#E0E0E0]">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5 text-[#E0E0E0]"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg>
                                    4.9
                                  </div>
                                </div>
                              </div>
