    ...
    <main className="pt-20" id="home">
      ...
      <section className="relative h-screen flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="mt-4 text-base sm:text-lg text-white" data-animate>Connect with local hosts in rural, less-traveled places. Each booking supports community-led, sustainable tourism.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 p-3">
              ...
              <div className="flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] px-3 py-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-[#BB86FC]">
                ...
                <DatePicker
                  ...
                  className="placeholder-[#E0E0E0]/60 focus:outline-none text-sm bg-transparent w-full text-white"
                />
              </div>
              <div className="flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] px-3 py-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-[#BB86FC]">
      ...
      {/* How it works */}
      <section className="border-y border-[rgba(255,255,255,0.1)] pt-14 pb-14 bg-[#121212]" data-bg="dark">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] p-5 hover:border-[rgba(255,255,255,0.2)] transition-all duration-300" data-animate>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center" data-animate>
            ...
            <div className="mt-4 flex justify-center">
              <Link to="/share-photo" className="btn-adaptive rounded-md px-4 py-2 text-sm font-semibold border inline-flex items-center text-[#BB86FC] border-[#BB86FC]/50 hover:bg-[#BB86FC]/10">
