...
const Explore = () => {
  ...
  return (
    <section id="explore" className="bg-transparent">
      <div className="mx-auto w-full max-w-7xl px-4 pt-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-end">
            <div>
              <h1 className="text-3xl font-semibold tracking-tight text-neutral-200">Explore stays</h1>
              <p className="mt-1 text-sm text-neutral-400">Curated homestays with a focus on sustainability and local impact.</p>
            </div>
            <div className="flex w-full gap-2 sm:w-auto">
              <div className="flex min-w-0 flex-1 items-center gap-2 rounded-lg border border-neutral-700 bg-transparent px-3 py-2 sm:w-80">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-gray-400 dark:text-gray-400"><path d="m21 21-4.34-4.34"></path><circle cx="11" cy="11" r="8"></circle></svg>
                <input id="searchInput" type="text" placeholder="Search for properties..." className="w-full border-0 bg-transparent text-sm text-neutral-200 placeholder-neutral-400 focus:outline-none" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
              </div>
              <button id="resetBtn" className="inline-flex items-center gap-2 rounded-lg border border-neutral-700 bg-transparent px-3 py-2 text-sm font-medium text-neutral-400 hover:bg-neutral-800" onClick={resetFilters}>
          ...
          <div className="flex flex-col gap-3 rounded-xl border border-neutral-800 bg-[#1E1E1E] p-3 sm:p-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div className="flex items-center gap-2 rounded-lg border border-neutral-700 bg-transparent px-3 py-2">
                ...
                <select id="ecoSelect" className="w-full appearance-none border-0 bg-transparent text-sm text-neutral-200 focus:outline-none" value={filters.eco} onChange={e => handleFilterChange('eco', e.target.value)}>
                  <option value="" className="bg-[#1E1E1E] text-neutral-200">Sustainability</option>
                  <option value="certified" className="bg-[#1E1E1E] text-neutral-200">Eco+ Certified</option>
                  <option value="community" className="bg-[#1E1E1E] text-neutral-200">Community-led</option>
                  <option value="plastic-free" className="bg-[#1E1E1E] text-neutral-200">Plastic-free</option>
                </select>
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center justify-between border-t border-neutral-800 pt-4">
            <p className="text-xs text-neutral-400">Showing {filteredProperties.length} of {properties.length}</p>
            <div className="flex items-center gap-2">
              <button className="inline-flex items-center rounded-md border border-neutral-700 bg-transparent px-3 py-1.5 text-sm text-neutral-400 hover:bg-neutral-800">
