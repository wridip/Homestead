  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <a href="#" className="inline-flex items-center justify-center rounded-md border border-border p-2 hover:bg-accent transition text-foreground" aria-label="Twitter">
              ...
              <a href="#" className="inline-flex items-center justify-center rounded-md border border-border p-2 hover:bg-accent transition text-foreground" aria-label="Instagram">
              ...
              <a href="#" className="inline-flex items-center justify-center rounded-md border border-border p-2 hover:bg-accent transition text-foreground" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><a href="#featured" className="text-muted-foreground hover:text-foreground transition">Featured stays</a></li>
              <li><a href="#impact" className="text-muted-foreground hover:text-foreground transition">Impact</a></li>
              <li><a href="#host" className="text-muted-foreground hover:text-foreground transition">Become a host</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-semibold tracking-tight text-foreground">Support</h4>
            <ul className="mt-3 space-y-2 text-sm">
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition">Help Center</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition">Cancellation options</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition">Safety information</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-border pt-6 text-xs text-muted-foreground/60">
