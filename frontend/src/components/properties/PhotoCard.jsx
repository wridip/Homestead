    ...
    <article className="flex flex-col overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] hover:border-[rgba(255,255,255,0.2)]" data-animate>
      ...
      <div className="p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-1 text-xs text-[#E0E0E0]/60">{photo.tag}</span>
        </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="inline-flex items-center gap-3 text-xs text-[#E0E0E0]">
            <span className="inline-flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-[#BB86FC]"><path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"></path></svg>
              {photo.likes}
            </span>
            <span className="inline-flex items-center gap-1">
          ...
          <button className="rounded-md border border-[rgba(255,255,255,0.1)] px-3 py-1.5 text-xs font-medium hover:border-[rgba(255,255,255,0.2)] transition inline-flex items-center text-[#E0E0E0]">
