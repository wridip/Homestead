  ...
  return (
    <article className="group overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[#1E1E1E] shadow-sm" data-animate>
      <div className="relative">
        <img src={property.images && property.images.length > 0 ? `http://localhost:5000/${property.images[0].replace(/\\/g, '/')}` : 'https://via.placeholder.com/300'} alt={property.name} className="h-56 w-full object-cover transition duration-300 group-hover:scale-105" />
